                        ...
                        <div class="repeater-table">
                            ...
                            <div class='cl-repeater-inside hidden'>
                                ...
                                <p>
                                    ...
                                    <input type="button" value="<?php esc_attr_e('Upload Image', 'construction-light'); ?>" class="button media-image-upload"data-title="<?php esc_attr_e('Upload Client Image', 'construction-light'); ?>" data-button="<?php esc_attr_e('Select Background Image', 'construction-light'); ?>"/>

                                    <input type="button" value="<?php esc_attr_e('Remove Image', 'construction-light'); ?>" class="button media-image-remove"/>
                    ...
                    <div class="repeater-table">
                        ...
                        <div class='cl-repeater-inside hidden'>
                            ...
                            <p>
                                ...
                                <input type="button" value="Upload Image" class="button media-image-upload" data-title="<?php esc_attr_e('Select Client Image', 'construction-light'); ?>" data-button="<?php esc_attr_e('Select Client Image', 'construction-light'); ?>"/>
