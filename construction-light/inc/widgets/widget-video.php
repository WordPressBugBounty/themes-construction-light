    ...
    class construction_light_widget_calltoaction_video extends WP_Widget{
        ...
        public function form($instance){
            ...
            <p>
                ...
                <input type="button" value="Upload Image" class="button media-image-upload" data-title="<?php esc_attr_e('Select Background Image', 'construction-light'); ?>" data-button="<?php esc_attr_e('Select Background Image', 'construction-light'); ?>"/>
