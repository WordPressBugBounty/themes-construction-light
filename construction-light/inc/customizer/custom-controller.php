		...
		class Construction_Light_Upgrade_Text extends WP_Customize_Control {
	        ...
	        public function render_content() {
	            ...
	            <label>
	                ...
	                <a href="<?php echo apply_filters('construction-light-pro-link', esc_url('https://sparklewpthemes.com/wordpress-themes/constructionlightpro/') );?>" target="_blank"> <strong><?php echo esc_html__('Upgrade to PRO', 'construction-light'); ?></strong></a>
	            </label>
		...
		class Construction_Light_Upgrade_Section extends WP_Customize_Section {
	        ...
	        protected function render_template() {
	            ...
	            <li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }} cannot-expand">
	                ...
	                <a href="<?php echo apply_filters('construction-light-pro-link', esc_url('https://sparklewpthemes.com/wordpress-themes/constructionlightpro/') );?>" class="button button-primary" target="_blank"><?php echo esc_html__('Upgrade to Pro', 'construction-light'); ?></a>
	            </li>
	            <?php
	        }
	    }
